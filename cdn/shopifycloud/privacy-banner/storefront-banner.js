                            ...
                            case 2:
                                if ((i = o.sent()).errors) {
                                    if ((c = i.errors.find((function(n) {
                                        ...
                                        }))) && !n) return window.Weglot || c.message.includes("Argument 'language' on Directive 'inContext' has an invalid value") ? console.log("Banner localization error", c.message) : Ae(new Error(c.message), "DataFetching"), [2, this.getDataFromStorefrontApi(!0)];
