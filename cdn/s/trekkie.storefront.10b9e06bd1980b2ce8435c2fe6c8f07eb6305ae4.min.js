! function() {
    var e = {
            ...
            5732: function(e, t, n) {
                ...
                function c() {
                    const e = (null === (t = window.Shopify) || void 0 === t || null === (n = t.customerPrivacy) || void 0 === n ? void 0 : n.cachedConsent) || r.readCookie(s) || i.readHeaders();
                    var t, n;
            ...
            3988: function(e, t, n) {
                ...
                var C = function(e) {
                    ...
                    return r(n, e), n.prototype.name = function() {
                        ...
                        var r = t.properties,
                            a = h.isRemoteProduct(r) ? h.getRemoteEventName(e) : e;
                        ...
                        var n = e.properties;
                        if (!h.isRemoteProduct(n) || !g.default.isEnabled(g.SERVER_EMITTED_ADD_TO_CART_NEW_REPORTIFY_MIGRATION)) {
                            var o = {
                                    event_id: e.eventId,
                                    products: this.formatProductJSON([n]),
                                    total_value: this.formatRevenue(n.price),
                            ...
                            g.default.isEnabled(g.SERVER_EMITTED_ADD_TO_CART_NEW_REPORTIFY_MIGRATION) && (r = t.PRODUCT_ADDED_TO_CART_LEGACY_EVENT_NAME), this.fireEventForProductType(r, e, o)
                        }
                        ...
                        return i(i({
                            ...
                            asset_version_id: "10b9e06bd1980b2ce8435c2fe6c8f07eb6305ae4",
                    ...
                    }, n.prototype.getRequestId = function() {
                        var e, t, n;
                        try {
                            return null === (n = null === (t = null === (e = null === performance || void 0 === performance ? void 0 : performance.getEntriesByType("navigation")[0]) || void 0 === e ? void 0 : e.serverTiming) || void 0 === t ? void 0 : t.find((function(e) {
            ...
            1037: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToObserve()) {
                        var n = "10b9e06bd1980b2ce8435c2fe6c8f07eb6305ae4",
                            o = null,
                            r = null,
                            i = null;
                        if (e.app_config) try {
            ...
            7956: function(e, t, n) {
                ...
                t.isRemoteProduct = function(e) {
                    return !!o.default.isEnabled(o.F_AD_UPFUNNEL_TRACKING) && !0 === (null == e ? void 0 : e.remote)
                    ...
                    g = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "10b9e06bd1980b2ce8435c2fe6c8f07eb6305ae4",
